...
Dieses Repository enthält alle technischen Komponenten für das Homepage-Projekt **LG ESports** für das Valorant Team LG ESports. 
...
```bash
# Repository klonen
git clone https://github.com/CyZeTLC/lg-esports
